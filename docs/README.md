# OpenSolarCoolingHub Documention

This OpenSolarCoolingHub Documention website is built using [VitePress](https://vitepress.dev/), a Vite & Vue Powered Static Site Generator.
